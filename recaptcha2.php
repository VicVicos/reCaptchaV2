...
class plgCaptchaRecaptcha2 extends JPlugin
{
    ...
    public function __construct($subject, $config)
    {
        ...
        if ($this->type == 0) {
            $doc->addScript(self::RECAPTCHA_SCRIPT . '?onload=JoomlaInitReCaptcha2_0&render=explicit', 'text/javascript', true, true);
            $doc->addScript(self::RECAPTCHA_CALLBACK);
        } else {
